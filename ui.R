                      ...
                      tabItems(
                        ...
                        tabItem(tabName = "Model",
                                ...
                                box(
                                  ...
                                  p(" What you see is my first draft of an impact pathway. It shows empowerment from an economic perspective, 
                                  ...
                                  This is a general impact pathway that is applicable for several local situations. Many examples for local cases are shown within the mind map, 
                                  ...
                                  tags$br(p("The Option of sticking to the status quo leads down a path of losses. Empowerment as () found, 
                                  can be compared to a ladder: Depending on the situation the woman is in, the effects of the lack of Empowerment
                                  can be worse or less. But the general disadvantages stay the same. Many studies() state that women are not paid for
                                  their farm work as well as their domestic work (himmelweit). Several studies show that men share less food with their 
                                  ...
                                  p("Information about negotiations might require investments in education. In these cases, this step is essential.
                                    ...
                                    but the woman later will have to work more, this number replicates the cost for a time-use change. A beneficial factor might be a social environment beneficial for the female farmer. Other women from women's groups with who she could share transportation would be an excellent example in this case. But for all steps of the model, help from a positive environment could lower the cost for each step."),
                                  ...
                                  p("The economy part of the model also means costs like time use or child or elderly care payments.
                                    ...
                                    situation. If the study is done with a group of women, a shiny app with sliders might be helpful for a single woman to adapt the model for her
